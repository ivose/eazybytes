        ...
        .route(
            p ->
                p.path("/eazybank/accounts/**")
                    .filters(
                        f ->
                            f.rewritePath("/eazybank/accounts/(?<segment>.*)", PATH_SEGMENT)
        ...
        .route(
            p ->
                p.path("/eazybank/loans/**")
                    .filters(
                        f ->
                            f.rewritePath("/eazybank/loans/(?<segment>.*)", PATH_SEGMENT)
                                .addResponseHeader(X_RESPONSE_TIME, LocalDateTime.now().toString())
                                .retry(
                                    retryConfig ->
                                        retryConfig
        ...
        .route(
            p ->
                p.path("/eazybank/cards/**")
                    .filters(
                        f ->
                            f.rewritePath("/eazybank/cards/(?<segment>.*)", PATH_SEGMENT)
                                .addResponseHeader(X_RESPONSE_TIME, LocalDateTime.now().toString())
                                .requestRateLimiter(
                                    config ->
                                        config
